...
public class Stepdefs {
    ...
    public void userCreatedWithPassword(String username, String password) throws Throwable {
        inputLines.add(0, password);
        inputLines.add(0, username);
        inputLines.add(0, "new");
    }
